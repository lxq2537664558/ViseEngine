...
namespace SevenZip.Compression.LZ
{
    ...
    internal class BinTree : InWindow, IMatchFinder
	{
        ...
        /// 设置对象类型
        /// </summary>
        /// <param name="numHashBytes">哈希字节数量</param>
        ...
        /// 设置对象的流对象
        /// </summary>
        /// <param name="stream">输入输出流对象</param>
        ...
        /// <param name="limit">限定值</param>
        /// <returns>返回相应的长度</returns>
		public new UInt32 GetMatchLen(Int32 index, UInt32 distance, UInt32 limit)
		{ return base.GetMatchLen(index, distance, limit); }
        /// <summary>
        /// 获取可用字节的数量
        /// </summary>
        /// <returns>返回可用字节的数量</returns>
        ...
        /// <param name="subValue">删除的值</param>
        ...
        /// 设置砍掉的值
        /// </summary>
        /// <param name="cutValue">砍掉的值</param>
