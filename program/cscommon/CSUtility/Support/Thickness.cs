...
namespace CSUtility.Support
{
    ...
    public struct Thickness : IEquatable<CSUtility.Support.Thickness>
    {
        //
        // Summary:
        ...
        //     false.
        public static bool operator !=(CSUtility.Support.Thickness t1, CSUtility.Support.Thickness t2)
        {
        ...
        {
            if (!(obj is CSUtility.Support.Thickness))
                return false;

            return Equals((CSUtility.Support.Thickness)obj);
        }
        //
        // Summary:
        ...
        //     true if the two instances of CSUtility.Support.Thickness are equal; otherwise,
        //     false.
        public bool Equals(CSUtility.Support.Thickness thickness)
        {
        ...
        {
            return (int)CSUtility.Support.UniHash.DefaultHash(this.ToString());// ToString().GetHashCode();
        }
        //
        // Summary:
