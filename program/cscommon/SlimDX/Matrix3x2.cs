...
namespace SlimDX
{
	...
	public struct Matrix3x2 : System.IEquatable<Matrix3x2>
	{
        ...
        public static Matrix3x2 Rotation(float angle, CSUtility.Support.PointF centerPoint)
	    {
        ...
        public static void Rotation(float angle, ref CSUtility.Support.PointF centerPoint, out Matrix3x2 result)
	    {
        ...
        /// <returns>返回计算后的矩阵</returns>
        public static Matrix3x2 Scale(CSUtility.Support.SizeF size)
	    {
		    Matrix3x2 r;
        ...
        /// <param name="size">缩放尺寸</param>
        /// <param name="result">计算后的矩阵</param>
        public static void Scale(ref CSUtility.Support.SizeF size, out Matrix3x2 result)
	    {
		    Matrix3x2 r;
        ...
        /// <returns>返回计算后的矩阵</returns>
        public static Matrix3x2 Scale(CSUtility.Support.SizeF size, CSUtility.Support.PointF centerPoint)
	    {
		    Matrix3x2 r;
        ...
        /// <param name="centerPoint">缩放中心</param>
        /// <param name="result">计算后的矩阵</param>
        public static void Scale(ref CSUtility.Support.SizeF size, ref CSUtility.Support.PointF centerPoint, out Matrix3x2 result)
	    {
		    Matrix3x2 r;
        ...
        /// <returns>返回计算后的矩阵</returns>
        public static Matrix3x2 Scale(float x, float y, CSUtility.Support.PointF centerPoint)
	    {
		    Matrix3x2 r;
        ...
        /// <param name="centerPoint">缩放中心点</param>
        /// <param name="result">计算后的矩阵</param>
        public static void Scale(float x, float y, ref CSUtility.Support.PointF centerPoint, out Matrix3x2 result)
	    {
		    Matrix3x2 r;
        ...
        /// <returns>返回计算后的矩阵</returns>
        public static Matrix3x2 Translation(CSUtility.Support.PointF point)
	    {
		    Matrix3x2 r;
        ...
        /// <param name="point">平移向量</param>
        /// <param name="result">计算后的矩阵</param>
        public static void Translation(ref CSUtility.Support.PointF point, out Matrix3x2 result)
	    {
		    Matrix3x2 r;
        ...
        public static CSUtility.Support.PointF TransformPoint(Matrix3x2 mat, CSUtility.Support.PointF point)
	    {
		    CSUtility.Support.PointF r = new CSUtility.Support.PointF();
        ...
        public static void TransformPoint(ref Matrix3x2 mat, ref CSUtility.Support.PointF point, out CSUtility.Support.PointF result)
	    {
            CSUtility.Support.PointF r = new CSUtility.Support.PointF();
