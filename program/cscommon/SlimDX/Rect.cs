namespace SlimDX
{
    ...
    public struct Rect
    {
        ...
        public static Rect Parse(string source)
        {
            ...
            return new Rect(System.Convert.ToSingle(splits[0]),
                            System.Convert.ToSingle(splits[1]),
                            System.Convert.ToSingle(splits[2]),
                            System.Convert.ToSingle(splits[3]));
        }
        /// <summary>
        /// 转换成string字符串
        /// </summary>
        ...
        public Rect(SlimDX.Vector2 location, Size size)
        {
            _x = location.X;
            _y = location.Y;
            _width = size.Width;
        ...
        /// 对象的位置坐标
        /// </summary>
        public SlimDX.Vector2 Location
        {
            get { return new SlimDX.Vector2(_x, _y); }
            set
            {
                _x = value.X;
                _y = value.Y;
        ...
        public Size Size
        {
            get { return new SlimDX.Size(_width, _height); }
            set
            {
                _width = value.Width;
        ...
        /// 只读属性，左上方坐标
        /// </summary>
        public SlimDX.Vector2 TopLeft
        {
            get { return new SlimDX.Vector2(Left, Top); }
        }
        /// <summary>
        /// 只读属性，右上方坐标
        /// </summary>
        public SlimDX.Vector2 TopRight
        {
            get { return new SlimDX.Vector2(Right, Top); }
        }
        /// <summary>
        /// 只读属性，左下方坐标
        /// </summary>
        public SlimDX.Vector2 BottomLeft
        {
            get { return new SlimDX.Vector2(Left, Bottom); }
        }
        /// <summary>
        /// 只读属性，右下方坐标
        /// </summary>
        public SlimDX.Vector2 BottomRight
        {
            get { return new SlimDX.Vector2(Right, Bottom); }
        }
        /// <summary>
        /// 是否包含某点
        /// </summary>
        ...
        public bool Contains(SlimDX.Vector2 point)
        {
        ...
        public static Rect Intersect(Rect rect1, Rect rect2)
        {
            ...
            var left = System.Math.Max(rect1.Left, rect2.Left);
            var top = System.Math.Max(rect1.Top, rect2.Top);
            var right = System.Math.Min(rect1.Right, rect2.Right);
            var bottom = System.Math.Min(rect1.Bottom, rect2.Bottom);
