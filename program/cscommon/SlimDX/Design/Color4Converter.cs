        ...
        public override Object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, Object value)
	    {
		    ...
		    if( Str != null )
		    {
			    ...
			    if( stringArray.Length == 1 )
			    {
				    ...
				    TypeConverter colorConverter = TypeDescriptor.GetConverter(typeof(CSUtility.Support.Color));
				    return new Color4( (CSUtility.Support.Color)( colorConverter.ConvertFromString( context, culture, Str ) ) );
			    }
			    else if( stringArray.Length == 3 )
			    {
				    ...
				    if( int.TryParse( stringArray[0],out red ) && int.TryParse( stringArray[1],out green ) && int.TryParse( stringArray[2],out blue ) )
					    return new Color4(CSUtility.Support.Color.FromArgb( red, green, blue ) );
			    ...
			    else if( stringArray.Length == 4 )
			    {
				    ...
				    if( int.TryParse( stringArray[0],out alpha ) && int.TryParse( stringArray[1],out red ) && int.TryParse( stringArray[2],out green ) && int.TryParse( stringArray[3],out blue ) )
					    return new Color4(CSUtility.Support.Color.FromArgb( alpha, red, green, blue ) );
