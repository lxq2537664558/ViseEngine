...
namespace UVAnimEditor
{
    ...
    public partial class ImageOperationPanel : UserControl
	{
        ...
        public delegate void Delegate_OnUpdateUVAnimFrames(UISystem.UVAnim uvAnim);
        public Delegate_OnUpdateUVAnimFrames OnUpdateUVAnimFrames;

        UISystem.UVAnim mUVAnim;
        UISystem.UVFrame mSelectedFrame;
        ...
        {
            get { return (string)GetValue(TextureFileProperty); }
            set { SetValue(TextureFileProperty, value); }
        }
        public static readonly DependencyProperty TextureFileProperty = DependencyProperty.Register("TextureFile", typeof(string), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata("", FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnTextureFileChanged)));
        ...
        public static void OnTextureFileChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            control.Image_Pic.Source = EditorCommon.ImageInit.GetImage(fileName);
        ...
        public static readonly DependencyProperty SelectRectLeftProperty = DependencyProperty.Register("SelectRectLeft", typeof(double), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnSelectRectLeftChanged)));
        ...
        public static void OnSelectRectLeftChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            panel.mSelectedFrame.UpdateScale9Infos();
        }
        ...
        public static readonly DependencyProperty SelectRectTopProperty = DependencyProperty.Register("SelectRectTop", typeof(double), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnSelectRectTopChanged)));
        ...
        public static readonly DependencyProperty SelectRectWidthProperty = DependencyProperty.Register("SelectRectWidth", typeof(double), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnSelectRectWidthChanged)));
        ...
        public static readonly DependencyProperty SelectRectHeightProperty = DependencyProperty.Register("SelectRectHeight", typeof(double), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnSelectRectHeightChanged)));
...
#region 处理箭头缩放
        ...
        public static readonly DependencyProperty ViewBoxWidthProperty = DependencyProperty.Register("ViewBoxWidth", typeof(double), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnViewBoxWidthChanged)));
        ...
        public static readonly DependencyProperty ViewBoxHeightProperty = DependencyProperty.Register("ViewBoxHeight", typeof(double), typeof(ImageOperationPanel),
                                                        new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnViewBoxHeightChanged)));
        ...
        public void SetUVAnim(UISystem.UVAnim uvAnim)
        {
            ...
            if(mUVAnim != null)
            {
                ...
                BindingOperations.SetBinding(this, TextureFileProperty, new Binding("Texture") { Source = mUVAnim, Mode = BindingMode.TwoWay, UpdateSourceTrigger = UpdateSourceTrigger.PropertyChanged });
        ...
        public void AddFrame()
        {
            ...
            {
                Background = new SolidColorBrush(Color.FromArgb(120, 0, 0, 0)),
                Text = "关键帧" + (mUsedRectangleList.Count - 1),
                IsHitTestVisible = false,
        ...
        public void RemoveFrame(int idx)
        {
            ...
            {
                mUsedTextBlockList[i].Text = "关键帧" + i;
            }
        ...
        private void ToggleButton_AutoSelect_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            mOperationMode = enOperationMode.AutoSelect;

            if (ToggleButton_Manual != null)
            {
                ToggleButton_Manual.IsChecked = false;
            }
        }
        private void ToggleButton_AutoSelect_Unchecked(object sender, System.Windows.RoutedEventArgs e)
        {
            if (mOperationMode == enOperationMode.AutoSelect)
                mOperationMode = enOperationMode.Unknow;
        }

        private void ToggleButton_ManualSelect_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            mOperationMode = enOperationMode.ManualSelect;

            if (ToggleButton_Auto != null)
            {
                ToggleButton_Auto.IsChecked = false;
            }
        }
        private void ToggleButton_ManualSelect_Unchecked(object sender, System.Windows.RoutedEventArgs e)
        {
            if (mOperationMode == enOperationMode.ManualSelect)
                mOperationMode = enOperationMode.Unknow;
        }
        ...
        private void Arrow_Left_L_MouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            Program.MousePoint pt;
            Program.GetCursorPos(out pt);
            Program.SetCursorPos(pt.X - delta, pt.Y);
        ...
        private void Arrow_Up_U_MouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            Program.MousePoint pt;
            Program.GetCursorPos(out pt);
            Program.SetCursorPos(pt.X, pt.Y - delta);
        ...
        private void Button_AutoGrid_Click(object sender, RoutedEventArgs e)
        {
            if (mUVAnim == null)
                return;
